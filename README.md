# blackhat-Session-Generator

> WhatsApp session generator for **𝐛𝐥𝐚𝐜𝐤 𝐡𝐚𝐭 𝐛𝐨𝐭 𝐦𝐝 / clevertechnexus** and any Baileys-based bot.  
> Supports **pair code** and **QR code** login, with optional **short session IDs** stored in MongoDB or PostgreSQL.

<a href='https://github.com/clevertechnexus/blackhat-session/fork' target="_blank">
...
| `SESSION_PREFIX` | Optional | Prefix prepended to session strings. Default: `BlackHat~` |
...
async function loadSession(SESSION_ID) {
    ...
    if (payload.length < 50) {
        ...
        const serverUrl = `https://clevertech.qzz.io/session/${payload}`;
...
```env
SESSION_ID=BlackHat~abc123xyz   # short session
# or
SESSION_ID=BlackHat~H4sIAAAAA...  # long session (full zlib string)
```
...
<a href='https://dashboard.heroku.com/new?template=https://github.com/clevertechnexus/blackhat-session' target="_blank">
...
[`https://session.clevertech.qzz.io`](https://session.clevertech.qzz.io)

---

## Owner

<a href="https://github.com/clevertechnexus">
  <img src="https://github.com/clevertechnexus.png" width="150" height="150" alt="clevertechnexus Tech" style="border-radius:50%"/>
</a>

[`ℹ️ Contact Owner`](https://api.clevertech.qzz.io/contact)


## Repo Star History

[![clevertechnexus-Session](https://api.star-history.com/svg?repos=clevertechnexus/blackhat-session&type=Timeline)](#)
