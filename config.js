...
module.exports = {
    ...
    DATABASE_URL: process.env.DATABASE_URL || "mongodb+srv://clevertechn_db_user:Xml4DXN9z5VwekeD@news.mt1a9z8.mongodb.net", // Your Db URL here(optional). Can either be mongodb or postreSQL
